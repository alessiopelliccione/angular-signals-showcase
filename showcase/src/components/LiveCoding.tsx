...
const LiveCoding = () => {
  const examples = [
    ...
    {
      id: "contacts-form",
      title: "Dynamic Contacts Form",
      label: "Dynamic Form",
      description: "Signal-based reactive form with dynamic array management, CRUD operations, and bi-directional data synchronization",
      whatWillLearn: [
      ...
      command: "npm run dev:contacts-form",
      port: "4200",
